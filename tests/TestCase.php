...
use Liberu\Ecommerce\CustomerServiceWorkspace\Filament\CustomerServiceWorkspaceFilamentServiceProvider;
...
abstract class TestCase extends PackageTestCase
{
    ...
    protected function getPackageProviders($app): array
    {
        return [
            ...
            CustomerServiceWorkspaceServiceProvider::class,
            CustomerServiceWorkspaceFilamentServiceProvider::class,
