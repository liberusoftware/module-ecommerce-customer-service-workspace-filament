 ...
 * both with a customer called `casey@example.test` waiting in a `web` queue is
 * the ordinary case, and a proof that creates one merchant's rows proves
 * nothing about a `where` clause nobody wrote.
 */
